...
/*  
Note: 
1. In table [customer_orders], change the datatype of column [order_time] from TIMESTAMP to DATETIME.
Otherwise, we can't insert new values to table [customer_orders].
